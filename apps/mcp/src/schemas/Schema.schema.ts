...
export const ZSchemaVersionId = z.string().describe('The ID of the schema version.');
export const ZSchemaVersion = z.string().describe('The version of the schema.');
export const ZSchemaDisplayName = z.string().describe('The display name of the schema version.');
...
export const ZSchemaType = z
  .enum(['jsonSchema', 'xsd', 'dtd', 'avro', 'protobuf'])

import type { JSONSchema7Type, JSONSchema7TypeName, JSONSchema7Version } from 'json-schema';
...
export interface MessageObject extends MessageTraitObject, SpecificationExtensions {
  // eslint-disable-next-line @typescript-eslint/no-explicit-any -- I just yanked the whole thing from the spec-repo
  payload?: any;
